...
<head>
    ...
    <title>Редактирование категории - Fortune</title>
...
<div class="container">
    <section class="section-index more-height">
        <h2 class="name-form"><b>РЕДАКТИРОВАНИЕ КАТЕГОРИИ</b></h2>
        <hr class="hr-circle">
        <form action="/admin/categories/edit/${category.id}" method="post">
            ...
            <div class="center-button">
                <button class="btn-custom" type="submit">СОХРАНИТЬ ИЗМЕНЕНИЯ</button>
                <a href="/admin/categories/list" class="btn btn-custom2">НАЗАД</a>
            </div>
        </form>
    </section>
</div>
