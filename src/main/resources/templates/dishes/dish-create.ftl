...
<head>
    ...
    <title>Создание блюда - Fortune</title>
...
<div class="container">
    <section class="section-index more-height">
        <h2 class="section-title"><b>Создание нового блюда</b></h2>
        <form action="/admin/dishes/create" method="post" enctype="multipart/form-data"
            ...
            <div class="form-group">
                ...
                <textarea class="form-field auto-expand" id="info" name="info"></textarea>
            ...
            <div class="center-button">
                <button type="submit" class="btn btn-custom">СОЗДАТЬ БЛЮДО</button>
