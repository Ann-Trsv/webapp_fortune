<!-- src/main/resources/templates/acess-registration.ftl -->
<!DOCTYPE html>
<html lang="ru">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Ожидание подтверждения регистрации - Fortune</title>
...
<div class="container">
    <section class="section">
        <h2 class="name-form"><b>ОЖИДАНИЕ ПОДТВЕРЖДЕНИЯ РЕГИСТРАЦИИ</b></h2>
        <form>
            <div class="form-group text-center">
                <p>Пожалуйста, подтвердите регистрацию, <br>перейдя по ссылке в письме, <br>которое пришло на Вашу
                    почту.</p>
                <div class="center-button">
                    <a href="/" class="btn btn-custom2">ГЛАВНАЯ</a>
                </div>
                <img class="img-status" src="../images/mail.svg" alt="ПИСЬМО">
            </div>
        </form>
    </section>
</div>
