...
<div class="container">
    <section class="section-index more-height">
        <h2 class="section-title"><b>ПРОДУКТЫ</b></h2>
        <hr class="hr-circle">
        <div class="center-button">
            <a href="/" type="button" class="btn btn-custom2">ГЛАВНАЯ</a>
            <a href="/admin/products/create" class="btn btn-custom">СОЗДАТЬ ПРОДУКТ</a>
            <a href="/dishes/list" type="button" class="btn btn-custom2">МЕНЮ</a>
        </div>
        <form action="/admin/products/list" method="get" class="center-button" style="margin-bottom: 20px">
        ...
        <table class="table table-bordered">
            ...
            <#list products as product>
                <tr>
                    ...
                    <td>${product.name}</td>
                    <td>
                        <a href="/admin/products/edit/${product.id}" class="btn blue">Редактировать</a>
                        <a href="/admin/products/delete/${product.id}" class="btn red">Удалить</a>
                    </td>
                </tr>
            </#list>
            </tbody>
